...
function OpenMenu(evt,level){
	...
	html  = '<span style="cursor: default; color:black; white-space:nowrap;" class="menuItem">'+login+leveltxt+'</span>'+
	'<a href="javascript:void(0)" class="menuItem" onclick="top.AddToPrivate(\''+login+'\');cMenu()">Приват</a>'+
	'<a href="javascript:void(0)" class="menuItem" onclick="window.open(\'http://capitalcity.oldbk.com/inf.php?login='+login+'\')"; cMenu();">Инфо</a>'+
	'<A href="javascript:void(0)" class="menuItem" onclick="AddToList(\''+login+'\',1);return false;">В друзья</A>'+
	'<A HREF="javascript:void(0)" class="menuItem" onclick="AddToList(\''+login+'\',2);return false;">Игнорировать</A>'+
	...
	'<A HREF="javascript:void(0)" class="menuItem" onclick="top.OpenGive(\''+login+'\');return false;">Передать</A>';
